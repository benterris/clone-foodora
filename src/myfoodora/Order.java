...
public class Order implements java.io.Serializable {
	...
	public double computeDueToRestaurant(){
		...
		return Math.floor(priceOfOrder*100)/100;
	}
	...
	public void computeFinalPrice(){
		...
		discountDueToCards = Math.floor((total - totalWithRed)*100)/100;
		
		price = Math.floor(totalWithRed*100)/100;
	...
	public void computeProfit(){
		this.profit = Math.floor((sys.getMarkupPercentage()*this.dueToRestaurant + sys.getServiceFee() - sys.getDeliveryCost() - discountDueToCards)*100)/100;
	}
